...
public class Test3UpdateStories extends JUnitStories {

	private final CrossReference xref = new CrossReference();

	public Test3UpdateStories() {
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new TestUpdateSteps());
	}

	@Override
	protected List storyPaths() {
		return Arrays.asList("test/resources/Update.story");
	}

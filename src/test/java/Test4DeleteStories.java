...
public class Test4DeleteStories extends JUnitStories {

	private final CrossReference xref = new CrossReference();

	public Test4DeleteStories() {
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new TestDeleteSteps());
	}

	@Override
	protected List storyPaths() {
		return Arrays.asList("test/resources/Delete.story");
	}

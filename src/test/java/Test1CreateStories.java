...
public class Test1CreateStories extends JUnitStories {

	private final CrossReference xref = new CrossReference();

	public Test1CreateStories() {
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new TestCreateSteps());
	}

	@Override
	protected List storyPaths() {
		return Arrays.asList("test/resources/Create.story");
	}
